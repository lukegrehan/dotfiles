...
alias mntPi='mkdir -p ~/Pi && sshfs luke@lukegrehan.com:/home/luke ~/Pi -o idmap=user && cd ~/Pi'
alias mntPiLocal='mkdir -p ~/Pi && sshfs luke@raspberrypi.local:/home/luke ~/Pi -o idmap=user && cd ~/Pi'
